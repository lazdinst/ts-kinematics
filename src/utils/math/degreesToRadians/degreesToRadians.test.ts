...
describe("degreesToRadians", () => {
  ...
  test("converts 90 degrees to π/2 radians", () => {
    expect(degreesToRadians(90)).toBeCloseTo(Math.PI / 2, 4);
  });

  test("converts 180 degrees to π radians", () => {
    expect(degreesToRadians(180)).toBeCloseTo(Math.PI, 4);
  });

  test("converts 360 degrees to 2π radians", () => {
    expect(degreesToRadians(360)).toBeCloseTo(2 * Math.PI, 4);
  });
  ...
  test("handles small degree values correctly", () => {
    ...
    expect(degreesToRadians(degrees)).toBeCloseTo(expected, 4);
  });
  ...
  test("handles non-integer degrees correctly", () => {
    ...
    expect(degreesToRadians(degrees)).toBeCloseTo(Math.PI / 3, 4);
  });
});
